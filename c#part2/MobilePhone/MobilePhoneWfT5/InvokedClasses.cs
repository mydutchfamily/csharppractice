...
namespace MobilePhoneWfT5
{
    public class InvokedClasses
    {
        ...
        public static ListViewItem[] UpdateFiltering(IEnumerable<IPhone> phones, FilterParams filterParams)
        {
        ...
        public static string[] FilteringSenders(IEnumerable<IPhone> phones)
        {
            IEnumerable<SmsMessage> allSms = new SmsMessage[0];
