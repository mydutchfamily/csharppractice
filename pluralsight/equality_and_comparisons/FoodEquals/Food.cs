...
namespace FoodEquals
{
    ...
    public struct CalorieCount :IComparable<CalorieCount>,IEquatable<CalorieCount>, IComparable
    {
        ...
        {
            return this._value.CompareTo(other._value);// using floating implementation 
        }
        ...
        public int CompareTo(object obj)// as it is not type safe
        {
            if (obj == null)
                throw new ArgumentException("obj");
            if (!(obj is CalorieCount))
                throw new ArgumentException("Expected Calories instance", "obj");
